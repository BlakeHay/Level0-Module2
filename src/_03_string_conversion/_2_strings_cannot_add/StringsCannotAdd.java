...
String fourAsString = JOptionPane.showInputDialog(null, "Enter the number 4 please.");
String sixAsString = JOptionPane.showInputDialog(null,"Enter the number 6 please.");
System.out.println(fourAsString + sixAsString);
String fiveAsString = JOptionPane.showInputDialog(null, "Enter the number five please.");
System.out.println(fiveAsString + fourAsString + sixAsString);
...
JOptionPane.showMessageDialog(null,sixAsInt + fourAsInt + fiveAsInt);
}
